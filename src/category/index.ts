...
export const workCategory: WorkCategoryEntry = {
  icon: 'mdi:briefcase',
  tools: [irpfCalculator, salaryCalculator, autonomosCalculator, reverseVatCalculator, invoiceGenerator, meetingCostCalculator, settlementCalculator, resignationLetterGenerator],
  i18n: {

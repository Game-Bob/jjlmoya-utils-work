...
export const content: ToolLocaleContent<SettlementCalculatorUI> = {
  ...
  { type: 'paragraph', html: "Перед использованием интерпретируйте результат вместе с допущениями, указанными калькулятором." },
  { type: 'paragraph', html: "Проверьте ввод, единицы, округление, дату и юрисдикцию: каждый параметр может изменить оценку." },
  { type: 'paragraph', html: "Внимательно укажите дату договора, оставшиеся дни отпуска, невыплаченные суммы и применимые нормы. Сохраните использованные допущения, чтобы проверить результат при изменении даты или законодательства. Перед решением сравните расчёт с документами работодателя." },],
};

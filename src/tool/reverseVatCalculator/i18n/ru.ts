...
export const content: ToolLocaleContent<ReverseVatCalculatorUI> = {
  ...
  { type: 'paragraph', html: "Используйте результат для планирования и сравнения сценариев; он не заменяет официальный расчёт или консультацию специалиста." },
  { type: 'paragraph', html: "Перед использованием интерпретируйте результат вместе с допущениями, указанными калькулятором." },
  { type: 'paragraph', html: "Перед использованием результата проверьте ставку НДС, единицы и применённое округление. Сохраните рассчитанную базу и сумму налога, чтобы сравнивать сценарии и иметь понятную запись расчёта." },],
};

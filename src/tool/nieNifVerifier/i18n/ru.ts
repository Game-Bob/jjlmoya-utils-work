...
export const content: ToolLocaleContent<NieNifVerifierUI> = {
  ...
  { type: 'paragraph', html: "Введите номер без лишних пробелов и проверьте тип документа перед проверкой. Инструмент оценивает формат и контрольную букву, но не подтверждает личность владельца, активность номера или наличие записи в государственном реестре." },
  { type: 'paragraph', html: "Проверьте ввод, единицы, округление, дату и юрисдикцию: каждый параметр может изменить оценку." },],
};

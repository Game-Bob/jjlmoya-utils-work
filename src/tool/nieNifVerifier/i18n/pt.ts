...
const bibliography = [
  {
    name: 'Agencia Tributaria: NIF para pessoas singulares e coletivas',
    url: 'https://sede.agenciatributaria.gob.es/Sede/procedimiento-recaudatorio-gestor/nif.html',
  },
  {
    name: 'Ministério do Interior: Estrutura do DNI e NIE',
    url: 'https://www.dnielectronico.es/PortalDNIe/PRF1_9._2.html?punto=5.2',
  },
  {
    name: 'BOE: Regulamentos Gerais de Gestão Fiscal',

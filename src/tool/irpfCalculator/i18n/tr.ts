...
export const content: ToolLocaleContent<IrpfCalculatorUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: '<strong>2026 net maaş simülasyonu</strong> temel bir finansal planlama aracıdır. Gerçek tasarruf kapasitenizi bilmek ve gelirinizin hangi kısmının kamu hizmetlerini desteklediğini anlamak, yatırımlar, ipotekler veya kariyer değişiklikleri hakkında bilinçli kararlar vermenizi sağlar.',
    },
  ],
};
